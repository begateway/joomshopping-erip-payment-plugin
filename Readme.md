...
*	Откройте способ оплаты _pm_erip_ и нажмите закладку _Конфигурация_. Здесь необходимо заполнить
  ...
  * Путь к услуге в дереве ЕРИП. Например, _"Расчет" ЕРИП -> Интернет-магазины/сервисы -> B -> bePaid.by_
...
Для тестирования оплаты через ЕРИП, введите в настройках номер сервиса _000000000_.
...
To test a payment via ERIP, enter in the module settings Service number _000000000_.
